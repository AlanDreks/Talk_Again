...
alphabet_and_syllables_data = ('а', 'б', 'в', 'г', 'д', 'е', 'ж', 'з', 'и', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т',
                               'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ы', 'э', 'ю', 'аб', 'яб', 'уб', 'юб', 'об', 'ёб',
                               'эб', 'еб', 'ыб', 'иб', 'ав', 'яв', 'ув', 'юв', 'ов', 'ёв', 'эв', 'ев', 'ыв', 'ив', 'аг',
                               'яг', 'уг', 'юг', 'ог', 'ёг', 'эг', 'ег', 'ыг', 'иг', 'ад', 'яд', 'уд', 'юд', 'од', 'ёд',
                               'эд', 'ед', 'ыд', 'ид', 'аж', 'яж', 'уж', 'юж', 'ож', 'ёж', 'эж', 'еж', 'ыж', 'иж', 'аз',
                               'яз', 'уз', 'юз', 'оз', 'ёз', 'эз', 'ез', 'ыз', 'из', 'ай', 'яй', 'уй', 'ой', 'ёй', 'эй',
                               'ей', 'ый', 'ий', 'ак', 'як', 'ук', 'юк', 'ок', 'ёк', 'эк', 'ек', 'ык', 'ик', 'ал', 'ял',
                               'ул', 'юл', 'ол', 'ёл', 'эл', 'ел', 'ыл', 'ил', 'ам', 'ям', 'ум', 'юм', 'ом', 'ём', 'эм',
                               'ем', 'ым', 'им', 'ан', 'ян', 'ун', 'юн', 'он', 'ён', 'эн', 'ен', 'ын', 'ин', 'ап', 'яп',
                               'уп', 'юп', 'оп', 'ёп', 'эп', 'еп', 'ып', 'ип', 'ар', 'яр', 'ур', 'юр', 'ор', 'ёр', 'эр',
                               'ер', 'ыр', 'ир', 'ас', 'яс', 'ус', 'юс', 'ос', 'ёс', 'эс', 'ес', 'ыс', 'ис', 'ат', 'ят',
                               'ут', 'ют', 'от', 'ёт', 'эт', 'ет', 'ыт', 'ит', 'аф', 'яф', 'уф', 'юф', 'оф', 'ёф', 'эф',
                               'еф', 'ыф', 'иф', 'ах', 'ях', 'ух', 'юх', 'ох', 'ёх', 'эх', 'ех', 'ых', 'их', 'ац', 'яц',
                               'уц', 'юц', 'оц', 'ёц', 'эц', 'ец', 'ыц', 'иц', 'аш', 'яш', 'уш', 'юш', 'ош', 'ёш', 'эш',
                               'еш', 'ыш', 'иш', 'ащ', 'ящ', 'ущ', 'ющ', 'ощ', 'ёщ', 'эщ', 'ещ', 'ыщ', 'ищ', 'ба', 'бя',
                               'бу', 'бю', 'бо', 'бё', 'бэ', 'бе', 'бы', 'би', 'ва', 'вя', 'ву', 'вю', 'во', 'вё', 'вэ',
                               'ве', 'вы', 'ви', 'га', 'гя', 'гу', 'гю', 'го', 'гё', 'гэ', 'ге', 'гы', 'ги', 'да', 'дя',
                               'ду', 'дю', 'до', 'дё', 'дэ', 'де', 'ды', 'ди', 'жа', 'жя', 'жу', 'жю', 'жо', 'жё', 'жэ',
                               'же', 'жи', 'за', 'зя', 'зу', 'зю', 'зо', 'зё', 'зэ', 'зе', 'зы', 'зи', 'ка', 'кя', 'ку',
                               'кю', 'ко', 'кё', 'кэ', 'ке', 'кы', 'ки', 'ла', 'ля', 'лу', 'лю', 'ло', 'лё', 'лэ', 'ле',
                               'лы', 'ли', 'ма', 'мя', 'му', 'мю', 'мо', 'мё', 'мэ', 'ме', 'мы', 'ми', 'на', 'ня', 'ну',
                               'ню', 'но', 'нё', 'нэ', 'не', 'ны', 'ни', 'па', 'пя', 'пу', 'пю', 'по', 'пё', 'пэ', 'пе',
                               'пы', 'пи', 'ра', 'ря', 'ру', 'рю', 'ро', 'рё', 'рэ', 'ре', 'ры', 'ри', 'са', 'ся', 'су',
                               'сю', 'со', 'сё', 'сэ', 'се', 'сы', 'си', 'та', 'тя', 'ту', 'тю', 'то', 'тё', 'тэ', 'те',
                               'ты', 'ти', 'фа', 'фу', 'фо', 'фё', 'фэ', 'фе', 'фы', 'фи', 'ха', 'хя', 'ху', 'хо', 'хё',
                               'хэ', 'хе', 'хы', 'хи', 'ца', 'цу', 'цо', 'це', 'цы', 'ци', 'ша', 'шу', 'шо', 'шэ', 'ше',
                               'ши', 'ща', 'щу', 'що', 'ще', 'щи')
