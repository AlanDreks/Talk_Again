...
#                                'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ы', 'э', 'ю', 'я', 'а', 'б', 'в', 'г', 'д', 'е', 'ж',
...
alphabet_and_syllables_data = ('аба', 'ага', 'аза', 'азу', 'азы', 'ака', 'Ама', 'ара', 'ату', 'аул', 'аут', 'Ева',
                               ...
                               'иди', 'или', 'имя', 'инь', 'Ира', 'ифа', 'йод', 'йух', 'оба', 'ого', 'Оля', 'ежик',
                               ...
                               'Ява', 'яга', 'Яго', 'яма', 'яму', 'Яна', 'ярд', 'Яша', 'сыр', 'я', 'ем', 'суп', 'абажур'
                               , 'я ем суп', 'я', 'тащу', 'бак', 'я тащу бак', 'ты', 'ешь', 'суп', 'ты ешь суп', 'ты',
                               'ешь', 'мясо', 'ты ешь мясо', 'я', 'иду', 'домой', 'я иду домой', 'ты', 'идешь', 'домой',
                               'ты идешь домой', 'Лена', 'идет', 'домой', 'Лена идет домой', 'я', 'буду', 'дома',
                               'я буду дома', 'мама', 'будет', 'жить', 'дома', 'мама будет жить дома', 'я', 'буду',
                               'чуть-чуть', 'супа', 'я буду чуть-чуть супа', 'я', 'пью', 'воду', 'я пью воду', 'Ира',
                               'будет', 'пить', 'Ира будет пить', 'я', 'Маша', 'будет',
                               'петь', 'Маша будет петь', 'я', 'учу', 'тебя', 'я учу тебя', 'папа', 'учит', 'меня',
                               'папа учит меня', 'папа', 'сел', 'сюда', 'папа сел сюда', 'мама', 'села', 'туда',
                               'мама села туда', 'я', 'буду', 'тут', 'я буду тут', 'я', 'буду', 'там', 'я буду там',
                               'тут', 'я', 'иду', 'тут я иду', 'я', 'буду', 'там', 'я буду там', 'идем', 'туда',
                               'идем туда', 'идем', 'сюда', 'идем сюда', 'мне', 'надо', 'мне надо', 'они', 'идут',
                               'они идут', 'она', 'идет', 'она идет')
