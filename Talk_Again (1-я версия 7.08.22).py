...
alphabet_and_syllables_data = ('аба', 'ага', 'аза', 'азу', 'азы', 'ака', 'Ама', 'ара', 'ату', 'аул', 'аут', 'Ева',
                               ...
                               'Ява', 'явь', 'яга', 'Яго', 'яма', 'яму', 'Яна', 'ярд', 'Яша', 'сыр', 'я', 'ем', 'суп',
                               'я ем суп', 'я', 'ем', 'кашу', 'я ем кашу', 'ты', 'ешь', 'суп', 'ты ешь суп', 'ты',
                               'ешь', 'кашу', 'ты ешь кашу', 'я', 'иду', 'домой', 'я иду домой', 'ты', 'идешь', 'домой',
                               'ты идешь домой', 'мама', 'идет', 'домой', 'мама идет домой', 'я', 'буду', 'дома',
                               'я буду дома', 'мама', 'будет', 'жить', 'дома', 'мама будет жить дома', 'я', 'буду',
                               'чуть-чуть', 'супа', 'я буду чуть-чуть супа', 'я', 'хочу', 'пить', 'я хочу пить', 'мама',
                               'будет', 'пить', 'мама будет пить', 'я', 'хочу', 'петь', 'я хочу петь', 'папа', 'будет',
                               'петь', 'папа будет петь', 'я', 'учу', 'тебя', 'я учу тебя', 'папа', 'учит', 'меня',
